...
export class AuthQueryWithdrawRequestBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class AuthQueryWithdrawRequest extends SpeakeasyBase {
    ...
    requestBody?: AuthQueryWithdrawRequestBody;
...
export class AuthQueryWithdrawResponse extends SpeakeasyBase {
    /**
