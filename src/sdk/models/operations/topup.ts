...
export class TopupRequestBodyAmount extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class TopupRequestBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "amount" })
    @Type(() => TopupRequestBodyAmount)
    amount?: TopupRequestBodyAmount;
...
export class TopupResponse extends SpeakeasyBase {
    /**
