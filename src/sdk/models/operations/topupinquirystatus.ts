...
export class TopupInquiryStatusRequestBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class TopupInquiryStatusRequest extends SpeakeasyBase {
    ...
    requestBody?: TopupInquiryStatusRequestBody;
...
export class TopupInquiryStatusResponse extends SpeakeasyBase {
    /**
